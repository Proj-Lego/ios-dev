...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if user != nil {
            ...
            let rootTabVC = homeStoryboard.instantiateViewController(identifier: "HomeTabBarViewController") as! UITabBarController
            self.window?.rootViewController = rootTabVC
        } else {
            let loginStoryboard = UIStoryboard.init(name: "Main", bundle: nil)
            let loginVC = loginStoryboard.instantiateViewController(withIdentifier: "GetStartedViewController") as! GetStartedViewController
